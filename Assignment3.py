...
print(f"Final price after discount: {final_price}")  # Output: 75.0

discount = 15.0  # 15% discount
final_price = calculate_discount(original_price, discount)
print(f"Final price after discount: {final_price}")  # Output: 100.0 (no discount applied)
...
# When discount is applied (≥ 20%), the user will be prompted to enter the price and discount percentage.
# Example output: Enter the original price of the item: 100
# Enter the discount percentage: 25
#Final proce after 25.0% discount: 75%

#When no discount is applied (< 20%):
#Enter the discount percentage: 15
#No discount applied. Original price: 100.0
